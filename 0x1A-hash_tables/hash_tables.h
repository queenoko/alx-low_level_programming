...
/**
 * struct hash_table_s - Data structure for Hash table
 * @size: size of array
 * @array: array of size @size
 * Each cell of this array is a pointer to the first node of a linked list
 * to use a chaining collision handling for HashTable
 */
 ...
 * @key: Key string, unique key for hash table
...
/**
 * struct shash_table_s -  Data structure for sorted hashed table
 * @size: Size of array
 * @array: Array of @size. Each cell of this array is a pointer to first node
 * of linked list, so hash table uses chaining collision handling
